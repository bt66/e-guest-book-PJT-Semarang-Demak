<script lang="ts">
	...
	import kementerianPuLogo from '$lib/icons/kementerian_pu.svg';
	let { children } = $props();
</script>
<style>
  :global(body) {
    margin: 0;
    background-color: #282c34; /* your color */
    color: white;
  }
</style>
<svelte:head>
...
<div class="flex flex-col min-h-screen ">
	<nav class="fixed top-0 w-full border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
	  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
		<a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
			<img src={kementerianPuLogo} class="h-8" alt="Logo Kementerian PU" />
			<span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PJT Semarang Demak</span>
		</a>
